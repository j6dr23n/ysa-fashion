...
<body>
    <div class="ps-page--comming-soon">
        <div class="container">
            <div class="ps-page__header"><a class="ps-logo" href="#"><img src="img/bg/logo.png" alt=""></a>
                <h1> Coming Soon</h1>
                <p>Under Maintenance </p><a>Thanks for your inform.</a>
            </div>
